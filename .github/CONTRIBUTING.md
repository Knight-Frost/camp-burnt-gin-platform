...
|--------|-------------------------------|
| New API endpoint | API_OVERVIEW.md |
| New environment variable | README.md, INSTALLATION_AND_SETUP.md, .env.example |
| Security-related change | SECURITY.md |
| Architectural change | ARCHITECTURE.md |
| New requirement implemented | REQUIREMENTS_AND_TRACEABILITY.md |
| New feature completed | BACKEND_COMPLETION_STATUS.md |
