 ...
 *
 * Each application stores exactly 7 consent records (one per consent_type).
 * All 7 types returned by requiredTypes() are mandatory for a complete submission.
 ...
 *   'general'       — General camp participation consent
...
class ApplicationConsent extends Model
{
    ...
    {
        return ['general', 'photos', 'liability', 'activity', 'authorization', 'medication', 'hipaa'];
    }
}
