 ...
 *
 * A CampSession is a standalone scheduled event (e.g., "Week 1: June 2–8, 2026").
 * Sessions are the actual objects that families apply to — they have capacity limits and
 * registration open/close dates.
 *
 * Authorization rules:
 *   - Viewing: any authenticated user; non-admins only see active sessions
 *   - Filtering: supports available_only query parameter for the applicant portal
 ...
 *   GET    /api/sessions/{session}    — show a single session
...
class CampSessionController extends Controller
{
     ...
     *
     * Supports one optional query filter:
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $query = CampSession::withCount(['applications as enrolled_count' => function ($q) {
