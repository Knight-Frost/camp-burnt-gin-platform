...
| `expires_at` | timestamp | Expiration timestamp (60 minutes) |
...
Tokens automatically expire 60 minutes after creation. This enforces HIPAA-compliant automatic session timeout.
...
4. Hash token and store with 60-minute expiration
...
2. Check token not expired (60 minutes)
...
| Expiration | Token becomes invalid after 60 minutes |
