...
class KatharinaSparrowSeeder extends Seeder
{
    ...
    private function createDiagnoses(Camper $camper): void
    {
        ...
        Diagnosis::firstOrCreate(
            ...
            [
                'description'    =>
                    'Mild persistent asthma, well-controlled. Triggers: cold air, high pollen, ' .
    ...
    private function createMedications(Camper $camper): void
    {
        ...
        Medication::firstOrCreate(
            ...
            [
                ...
                'prescribing_physician' => 'Dr. Angela Pryor',
                'notes'                 =>
                    'Rescue inhaler — keep with camp nurse at all times. ' .
    ...
    private function createAllergies(Camper $camper): void
    {
        ...
        Allergy::firstOrCreate(
            ...
            [
                ...
                'treatment' =>
                    'Remove stinger (scrape — do NOT squeeze). Apply ice pack. ' .
    ...
    private function updateApplicationNarratives(Application $app): void
    {
        $app->update([
            ...
            'narrative_participation_concerns' =>
                'No significant concerns about full participation. The only physical limitation is ' .
            ...
            'narrative_heat_tolerance' =>
                'Kat tolerates heat reasonably well and is comfortable outdoors. Standard hydration ' .
            ...
            'narrative_transportation' =>
                'No special transportation accommodations required. Kat can ride a standard camp bus. ' .
            ...
            'narrative_emergency_protocols' =>
                'For asthma emergencies: administer rescue inhaler (albuterol 2 puffs), have Kat ' .
