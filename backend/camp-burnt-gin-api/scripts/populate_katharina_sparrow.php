...
Diagnosis::firstOrCreate(
    ...
    [
        'description' => 'Mild persistent asthma, well-controlled on controller therapy. '.
...
Medication::firstOrCreate(
    ...
    [
        ...
        'prescribing_physician' => 'Dr. Angela Pryor',
        'notes' => 'Rescue inhaler — keep with camp nurse at all times; Kat should NOT self-carry. '.
...
Allergy::firstOrCreate(
    ...
    [
        ...
        'treatment' => 'Remove stinger if present (scrape — do NOT squeeze). Apply ice pack. '.
...
$app->update([
    ...
    'narrative_participation_concerns' => 'No significant concerns about full participation. The only limitation is exercise-'.
    ...
    'narrative_heat_tolerance' => 'Kat tolerates heat reasonably well. She is active and comfortable outdoors. '.
    ...
    'narrative_transportation' => 'No special transportation accommodations required. Kat can ride a standard '.
    ...
    'narrative_emergency_protocols' => 'For asthma emergencies: administer rescue inhaler (albuterol 2 puffs), have '.
